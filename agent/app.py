...
def get_openemr_token():
    ...
    resp = requests.post(
        ...
        data={
            ...
            "password": "pass",
            "user_role": "users",
            "scope": "openid api:fhir user/Patient.read user/Condition.read user/MedicationRequest.read user/AllergyIntolerance.read user/Encounter.read user/Observation.read user/Coverage.read user/Immunization.read user/DocumentReference.read user/Binary.read",
